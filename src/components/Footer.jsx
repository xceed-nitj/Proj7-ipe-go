...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden border-t border-blue-950 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
      ...
      {/* ===== Footer Content ===== */}
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-10 py-6 flex flex-col gap-12">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10">
          {/* ---- Contact Info ---- */}
          <div className="relative rounded-3xl bg-white/10 backdrop-blur-sm p-2 shadow-lg hover:shadow-xl transition-all duration-500 border border-white/10">
        ...
        {/* ---- Divider ---- */}
        <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-white/20 to-transparent my-0" />
